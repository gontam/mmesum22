...
# Student: Mba Samuel Henry, ME21M020
# Date: 03.04.2022
...
# Result: coding sequences within the start and stop codons is written to ‘BD137219.1_translated_mba.txt’
...
result = open('BD137219.1_translated_Mba.txt', 'w')
