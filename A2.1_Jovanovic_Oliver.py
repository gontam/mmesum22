...
#df = pd.DataFrame(dt)
#print(df)
dt = [['TTT', 'TCT', 'TAT', 'TGT', 'TTC', 'TCC', 'TAC', 'TGC', 'TTA', 'TCA', 'TAA', 'TGA', 'TTG', 'TCG', 'TAG', 'TGG', 'CTT', 'CCT', 'CAT', 'CGT', 'CTC', 'CCC', 'CAC', 'CGC', 'CTA', 'CCA', 'CAA', 'CGA', 'CTG', 'CCG', 'CAG', 'CGG', 'ATT', 'ACT', 'AAT', 'AGT', 'ATC', 'ACC', 'AAC', 'AGC', 'ATA', 'ACA', 'AAA', 'AGA', 'ATG', 'ACG', 'AAG', 'AGG', 'GTT', 'GCT', 'GAT', 'GGT', 'GTC', 'GCC', 'GAC', 'GGC', 'GTA', 'GCA', 'GAA', 'GGA', 'GTG', 'GCG', 'GAG', 'GGG'], ['F', 'S', 'Y', 'C', 'F', 'S', 'Y', 'C', 'L', 'S', '*', '*', 'L', 'S', '*', 'W', 'L', 'P', 'H', 'R', 'L', 'P', 'H', 'R', 'L', 'P', 'Q', 'R', 'L', 'P', 'Q', 'R', 'I', 'T', 'N', 'S', 'I', 'T', 'N', 'S', 'I', 'T', 'K', 'R', 'M', 'T', 'K', 'R', 'V', 'A', 'D', 'G', 'V', 'A', 'D', 'G', 'V', 'A', 'E', 'G', 'V', 'A', 'E', 'G'], ['Phe', 'Ser', 'Tyr', 'Cys', 'Phe', 'Ser', 'Tyr', 'Cys', 'Leu', 'Ser', 'Ter', 'Ter', 'Leu', 'Ser', 'Ter', 'Trp', 'Leu', 'Pro', 'His', 'Arg', 'Leu', 'Pro', 'His', 'Arg', 'Leu', 'Pro', 'Gln', 'Arg', 'Leu', 'Pro', 'Gln', 'Arg', 'Ile', 'Thr', 'Asn', 'Ser', 'Ile', 'Thr', 'Asn', 'Ser', 'Ile', 'Thr', 'Lys', 'Arg', 'Met', 'Thr', 'Lys', 'Arg', 'Val', 'Ala', 'Asp', 'Gly', 'Val', 'Ala', 'Asp', 'Gly', 'Val', 'Ala', 'Glu', 'Gly', 'Val', 'Ala', 'GLu', 'Gly']]
...
#    string = string.strip('\n')
#    listNew += string
#    print('Dict line', x, 'processed')
#    x += 1

#str2 = str2.join(listNew)
...
#print('The whole list is:', str2)
print('The whole list is:', dt)
# Delete unnecessary variables to save space.
del x, string, listNew, lengthFile, f, g, lines, dt, n, index
